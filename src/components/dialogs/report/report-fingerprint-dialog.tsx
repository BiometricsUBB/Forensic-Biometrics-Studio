...
import { generateFingerprintReportPdfWithDialog } from "@/lib/report/generate-report-fingerprint-pdf";
...
type ReportFingerprintDialogProps = {
    className?: string;
};

export function ReportFingerprintDialog({
    className,
}: ReportFingerprintDialogProps) {
    ...
    const onGenerate = async () => {
        ...
        try {
            ...
            await generateFingerprintReportPdfWithDialog({
                includeMatchedOnly,
