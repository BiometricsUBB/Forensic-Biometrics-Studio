...
const d: Dictionary = {
    ...
    Core: "Jądro",
    Delta: "Delta",
    RidgeBeginning: "Początek linii",
    RidgeEnding: "Zakończenie linii",
    Bifurcation: "Rozwidlenie",
    RidgeMerge: "Złączenie linii",
    Hook: "Haczyk",
    Section: "Odcinek",
    Bridge: "Mostek",
    Point: "Punkt",
    Pore: "Por",
    Lake: "Oczko",
    "Ridge protrusion": "Wypust krawędzi",
    "Ridge indentation": "Wgłębienie krawędzi",
    Dot: "Kropka",
    "Incipient ridge": "Linia szczątkowa",
    Scar: "Blizna",
    Crease: "Pęknięcie",
    Page: "Strona",
    "Note title": "Uwaga",
