...
const d: Dictionary = {
    ...
    "Feature type Core": "Core",
    "Feature type Delta": "Delta",
    "Feature type RidgeBeginning": "Ridge beginning",
    "Feature type RidgeEnding": "Ridge ending",
    "Feature type Bifurcation": "Bifurcation",
    "Feature type RidgeMerge": "Ridge merge",
    "Feature type Hook": "Hook",
    "Feature type Section": "Section",
    "Feature type Bridge": "Bridge",
    "Feature type Point": "Point",
    "Feature type Pore": "Pore",
    "Feature type Lake": "Lake",
    "Feature type Ridge protrusion": "Ridge protrusion",
    "Feature type Ridge indentation": "Ridge indentation",
    "Feature type Dot": "Dot",
    "Feature type Incipient ridge": "Incipient ridge",
    "Feature type Scar": "Scar",
    "Feature type Crease": "Crease",
    Page: "Page",
    "Note title": "Note",
    "Note body":
