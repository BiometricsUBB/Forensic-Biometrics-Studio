...
const d: Dictionary = {
    ...
    Core: "Core",
    Delta: "Delta",
    RidgeBeginning: "Ridge beginning",
    RidgeEnding: "Ridge ending",
    Bifurcation: "Bifurcation",
    RidgeMerge: "Ridge merge",
    Hook: "Hook",
    Section: "Section",
    Bridge: "Bridge",
    Point: "Point",
    Pore: "Pore",
    Lake: "Lake",
    "Ridge protrusion": "Ridge protrusion",
    "Ridge indentation": "Ridge indentation",
    Dot: "Dot",
    "Incipient ridge": "Incipient ridge",
    Scar: "Scar",
    Crease: "Crease",
    Page: "Page",
    "Note title": "Note",
