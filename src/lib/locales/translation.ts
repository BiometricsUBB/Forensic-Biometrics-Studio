...
export type i18nReport = Recordify<
    ...
    | "Feature type Core"
    | "Feature type Delta"
    | "Feature type RidgeBeginning"
    | "Feature type RidgeEnding"
    | "Feature type Bifurcation"
    | "Feature type RidgeMerge"
    | "Feature type Hook"
    ...
    | "Feature type Pore"
    | "Feature type Lake"
    | "Feature type Ridge protrusion"
    | "Feature type Ridge indentation"
    | "Feature type Dot"
    | "Feature type Incipient ridge"
    | "Feature type Scar"
    | "Feature type Crease"
    | "Page"
    | "Note title"
