...
import { formatBytes, formatReportDateTime, md5String } from "./report-utils";
import { getImageMeta, renderImageWithMarkings } from "./shared/render-utils";
import {
    ...
    `;
        ...
        try {
            ...
            applyReportPdfMetadata(
                pdf,
                appVersion,
                tReport("Signature verification report title"),
                reportId
            );
            ...
            const filePath = await save({
                ...
                defaultPath: `signature-report-${reportId}.pdf`,
            });
