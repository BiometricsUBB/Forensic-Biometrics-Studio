        ...
        <main className="relative z-10 w-full flex flex-col items-center justify-center px-8">
            ...
            <div className="w-full max-w-2xl">
                <header className="text-center mb-14">
                    ...
                    <h1 className="text-5xl font-semibold text-foreground tracking-tight leading-[1.15] pb-1">
                    ...
                    {modes.map(mode => {
                        ...
                        return (
                            ...
                            >
                                <div
                                    aria-hidden="true"
                                    className="flex items-center justify-center w-20 shrink-0 border-r border-border bg-primary/10 text-primary transition-colors duration-300 group-hover:bg-primary group-hover:text-primary-foreground group-hover:border-primary"
                                >
